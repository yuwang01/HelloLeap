...
{
	return mat3 (
		a.v[0]*b.v[0], a.v[1]*b.v[0], a.v[2]*b.v[0],
		a.v[0]*b.v[1], a.v[1]*b.v[1], a.v[2]*b.v[1],
		a.v[0]*b.v[2], a.v[1]*b.v[2], a.v[2]*b.v[2]
	);
}
...
{
	return mat4 (
		a.v[0]*b.v[0], a.v[1]*b.v[0], a.v[2]*b.v[0], a.v[3]*b.v[0],
